...
comment on view public.ireba_sales_rows is
  'Dashboard-compatible iReba sales rows with external staff labels normalized to their code prefix. Only 明細区分=1技工 rows are included; Fukuoka department_id=6 is intentionally excluded.';
