# supabase/migrations/20260610164500_create_clinic_asset_sales_aggregates.sql
...
Supabase/Postgresのマイグレーションです。変更テーマは「create clinic asset sales aggregates」です。
