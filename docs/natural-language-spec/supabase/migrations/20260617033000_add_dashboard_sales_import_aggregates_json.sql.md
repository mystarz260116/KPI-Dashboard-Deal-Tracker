# supabase/migrations/20260617033000_add_dashboard_sales_import_aggregates_json.sql
...
Supabase/Postgresのマイグレーションです。変更テーマは「add dashboard sales import aggregates json」です。
